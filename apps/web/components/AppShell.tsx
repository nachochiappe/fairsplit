...
function AppShellContent({
  ...
  return (
    ...
    >
      <header className="mb-7 flex flex-col gap-5 rounded-3xl border border-stroke/80 bg-surface p-6 shadow-sm md:flex-row md:items-center md:justify-between md:p-9">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <h1 className="mt-2 text-pretty text-3xl font-bold tracking-tight text-ink-strong md:text-5xl">
              {title}
            </h1>
